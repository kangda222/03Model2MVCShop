...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr>
		...
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150">금액</td>
	</tr>
	<tr>
	...
	<c:forEach var="purchase" items="${list}">
		...
		<tr class="ct_list_pop">
			...
			<td align="left"><c:if test="${purchase.tranCode.trim()==2}"><a href="/updateTranCode.do?tranNo=${purchase.tranNo}&tranCode=3">구매하기</a></c:if>
